    ...
    <section className="relative z-10 space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
      <div className="flex items-center justify-between border-b border-white/5 pb-6">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Timeline of your professional journey and achievements.</p>
        </div>
        <button
          onClick={add}
        ...
        {rows.map((r, idx) => (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Company */}
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 ml-1">Company / Organization</label>
                <input
                  className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-white text-sm focus:bg-white/[0.06] focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:text-slate-700"
              ...
              <div className="md:col-span-2 space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 ml-1">Key Responsibilities</label>
                <textarea
                  ...
                  placeholder="Summarize your impact and achievements..."
                  value={r.details}
      ...
      {rows.length === 0 && (
        <div className="py-20 text-center border-2 border-dashed border-white/5 rounded-[2rem]">
          <p className="text-slate-600 text-sm">No work experience added. Use the button to build your timeline.</p>
        </div>
      )}

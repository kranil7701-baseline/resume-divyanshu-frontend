        ...
        <form className="mt-8 space-y-6 bg-slate-800 p-8 rounded-2xl shadow-xl border border-white/10" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <button
                type="button"
                className="w-full inline-flex justify-center py-3 px-4 border border-white/10 rounded-lg shadow-sm bg-slate-700 text-sm font-medium text-slate-200 hover:bg-slate-600 transition-colors"
              >

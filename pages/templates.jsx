        ...
        <div className="min-h-screen bg-slate-950 text-white selection:bg-blue-600/30">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-40">
                <div className="text-center mb-24">
                    ...
                    <div className="mt-8">
                        <Link href="/saved-templates" className="inline-block bg-blue-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-blue-500 transition-all hover:scale-105 shadow-lg shadow-blue-500/25">
